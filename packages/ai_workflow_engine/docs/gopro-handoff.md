...
Status: **`engine-v0.11.4` is released.** GoPro should pin tag `engine-v0.11.4`, record the source
...
| Package | GoPro use |
|---|---|
| `ai-workflow-engine==0.11.4` | Required in the detection/sidecar runtime |
