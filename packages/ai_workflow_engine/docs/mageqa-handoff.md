...
pin tag `engine-v0.11.1` from a clean checkout, rebuild wheels, and pass its E0 canaries before
...
| Package | MageQA use |
|---|---|
| `ai-workflow-engine==0.11.1` | Required orchestration/runtime |
...
persisted schema, or MageQA workflow behavior changes. Read the annotated tag for the exact source
