...
Consume it the way GoPro does — see `docs/working-against-the-freeze.md` (the canonical pin/upgrade
protocol): pin an **immutable tag**, never track the branch. **Important:** since v0.4.0,
